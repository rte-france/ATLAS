...
| Simulations FrBM | `frbm_simulations_main.py` (389 l.) + `OptimizationFiles/` hors thermique (605 l.) — interface `OptimisationModel` | 4.5j |
| Contraintes dynamiques thermiques | `thermal_dynamic_constraints.py` (3 768 l.) — **risque principal**, migration + découpage obligatoire en sous-fichiers | 8j |
| Refactor opportuniste | Split fichier 3 768 l. | 1j |
| **Total TSO** | | **~20j** |

**Sous-total migration : ~36.5j**
