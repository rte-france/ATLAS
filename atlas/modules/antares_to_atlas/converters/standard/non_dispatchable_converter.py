...
from atlas.modules.antares_to_atlas.models.other import convert_other_non_dispatchable_units
...
class NonDispatchableConverter(Converter):
    ...
    def convert(
        ...
        return convert_other_non_dispatchable_units(study, parameters, shared_state)
