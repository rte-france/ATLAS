...
Module that implements BalancingSolar.
"""
...
class BalancingSolar(BalancingEquipmentMixin, Solar):
    """Solar equipment subclass for the Balancing Orders Formulation module.
