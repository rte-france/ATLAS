...
class MarketAreaPO(MarketArea):
    ...
    def validate_market_specific_prices(self):
        ...
        """
        # Get market context - this should be passed when creating the model
        context = getattr(self, "_market_context", None)
        if context is None:
    ...
    def set_market_context(self, market_type: MarketType, use_forecast: bool = False):
        ...
        self._market_context = {"market_type": market_type, "use_forecast": use_forecast}
