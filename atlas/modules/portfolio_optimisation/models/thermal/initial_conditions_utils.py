...
def initialize_gradient_initial_conditions(
    ...
    :rtype: None
    """
    start_date_minus_one = parameters.temporal.start_date - parameters.temporal.timestep
    start_date_minus_two = parameters.temporal.start_date - 2 * parameters.temporal.timestep
