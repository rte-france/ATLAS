...
class ObjectiveFunctionBuilder:
    ...
    def _add_reserve_penalties(self, obj_function: list, portfolio: PO_portfolio, time: DateTime):
...
class OptimalPlacementOptimizer:
    ...
    def _create_po_portfolio(self, portfolio: Portfolio, equipment_dict: dict[EquipmentType, list]) -> PO_portfolio:
...
def output_marker_update(marker_equipment, optim_equipment, equipment_type: str, parameters):
    ...
    cfg.logger.info(f"Updating {equipment_type} equipment: {marker_equipment.name}")
