...
from atlas import Wind, Timeseries, Solar
...
class SolarOrdersFormulator(AbstractOrdersFormulator[Solar]):
    ...
    def formulate_orders(
        ...
        for equipment in equipments:
            ...
            for t in orders_timestamps:
                ...
                bid_name = WindOrdersFormulator.ORDER_NAME_TEMPLATE.format(
                    get_date_to_clean_string(parameters.execution_date), equipment.name, get_date_to_clean_string(t)
                )
                curtailment_bid_name = WindOrdersFormulator.CURTAILMENT_ORDER_NAME_TEMPLATE.format(
                    get_date_to_clean_string(parameters.execution_date), equipment.name, get_date_to_clean_string(t)
                )
