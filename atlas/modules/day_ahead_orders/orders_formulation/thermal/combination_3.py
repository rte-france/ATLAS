...
def execute(model: ThermalOptimizationModel, day_zero: bool) -> None:
    ...
    for t in model.time_frame_union_minus_one:
        ...
        # Enforces eq. (9)
        model.add_constraint(
            model.OFF.get_value(t) + model.ON_UP[t] + model.ON_DOWN.get_value(t) + model.ON_FLAT[t] == 1,
    ...
    for t in model.time_frame_union_minus_one:
        ...
        model.add_constraint(
            model.ON_DOWN.get_value(t_minus_one) + model.ON_UP[t] <= 1,
    ...
    for t in model.time_frame:
        ...
        model.add_constraint(
            ...
            <= model.q_upper.get_value(t) * (1 - model.ON_UP[t] - model.ON_DOWN.get_value(t) - model.OFF.get_value(t))
    ...
    for t in model.time_frame:
        ...
        model.add_constraint(
            model.q[t] <= model.q_upper.get_value(t) * (model.ON_UP[t] + model.ON_DOWN.get_value(t) + model.ON_FLAT[t]),
