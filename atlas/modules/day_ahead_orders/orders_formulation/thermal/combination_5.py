...
def execute(model: ThermalOptimizationModel, day_zero: bool) -> None:
    ...
    for t in model.time_frame_union_minus_one:
        ...
        # Enforces eq. (9)
        model.add_constraint(
            model.OFF.get_value(t) + model.ON_UP[t] + model.ON_DOWN[t] + model.ON_FLAT[t] + model.STOP[t] == 1,
    ...
    for t in model.time_frame:
        ...
        # Eq. (12)
        model.add_constraint(
            model.OFF.get_value(t_minus_one) + model.STOP[t] <= 1,
    ...
    for t in model.time_frame:
        ...
        model.add_constraint(
            ...
            * (1 - model.ON_UP[t] - model.ON_DOWN[t] - model.OFF.get_value(t) - model.STOP[t])
        )
