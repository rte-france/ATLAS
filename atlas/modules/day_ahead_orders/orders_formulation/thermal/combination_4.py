...
def execute(model: ThermalOptimizationModel, day_zero: bool) -> None:
    ...
    for t in model.time_frame:
        ...
        # Enforces eq. (9)
        model.add_constraint(
            model.OFF.get_value(t) + model.ON_UP.get_value(t) + model.ON_DOWN.get_value(t) + model.START[t] == 1,
    ...
    for t in model.time_frame:
        ...
        model.add_constraint(model.ON_UP.get_value(t_minus_one) + model.START[t] <= 1)  # eq. (10)
