...
INPUT_DIR = Path("tests/dataset/intraday/intraday_orders_input")
PARAMETERS_PATH = Path("tests/dataset/parameters/intraday/intraday_orders.yml")
...
def test_execution_time_within_threshold():
    ...
    check_execution_time("IntradayOrders", elapsed, "IntradayOrders")
